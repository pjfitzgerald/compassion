...
Post.create!(journal: Journal.find(1), content: "This is a test (1)", title: "This is a test title (1)")
Post.create!(journal: Journal.find(1), content: "This is a test (2)", title: "This is a test title (2)")
Post.create!(journal: Journal.find(1), content: "This is a test (3)", title: "This is a test title (3)")
Post.create!(journal: Journal.find(1), content: "This is a test (4)", title: "This is a test title (4)")
